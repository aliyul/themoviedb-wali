...
<body class="font-sans bg-gray-900 text-white">
    ...
    <nav class="border-b border-gray-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            <h1>Movies API</h1>
            <p>Select Category Movie API And Click Detail Movie Then Save The Movie To Local Movie</p>
    ...
    <ul class="flex flex-col md:flex-row items-center">
        ...
        <li class="md:ml-16 mt-3 md:mt-0">
            <a href="{{ route('movies.index') }}" class="hover:text-gray-300">Movies now Playing</a>
        </li>

        <li class="md:ml-16 mt-3 md:mt-0">
            <a href="{{ route('movies.popular') }}" class="hover:text-gray-300">Movies popular</a>
        </li>
        <li class="md:ml-16 mt-3 md:mt-0">
            <a href="{{ route('movies.toprated') }}" class="hover:text-gray-300">Movies top Rated</a>
        </li>
        <li class="md:ml-16 mt-3 md:mt-0">
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="d-flex">
                    <a class="btn btn-primary ml-auto" href="{{ route('localmovies.index')}}">Back To Movies Local CRUD</a>
                </div>
            </div>
        </div>
    </div>
